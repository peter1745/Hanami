...
namespace Hanami::HTML {
    ...
    inline static auto named_character_references = std::unordered_map<std::string_view, std::string_view>({
        { "&AElig", "\u{c6}" },
        { "&AElig;", "\u{c6}" },
        { "&AMP", "\u{26}" },
        { "&AMP;", "\u{26}" },
        ...
        { "&NotElement;", "\u{2209}" },
        { "&NotEqual;", "\u{2260}" },
        { "&NotEqualTilde;", "\u{2242}" },
        { "&NotExists;", "\u{2204}" },
        { "&NotGreater;", "\u{226f}" },
        { "&NotGreaterEqual;", "\u{2271}" },
        { "&NotGreaterFullEqual;", "\u{2267}" },
        { "&NotGreaterGreater;", "\u{226b}" },
        { "&NotGreaterLess;", "\u{2279}" },
        { "&NotGreaterSlantEqual;", "\u{2a7e}" },
        { "&NotGreaterTilde;", "\u{2275}" },
        { "&NotHumpDownHump;", "\u{224e}" },
        { "&NotHumpEqual;", "\u{224f}" },
        { "&NotLeftTriangle;", "\u{22ea}" },
        { "&NotLeftTriangleBar;", "\u{29cf}" },
        { "&NotLeftTriangleEqual;", "\u{22ec}" },
        { "&NotLess;", "\u{226e}" },
        { "&NotLessEqual;", "\u{2270}" },
        { "&NotLessGreater;", "\u{2278}" },
        { "&NotLessLess;", "\u{226a}" },
        { "&NotLessSlantEqual;", "\u{2a7d}" },
        { "&NotLessTilde;", "\u{2274}" },
        { "&NotNestedGreaterGreater;", "\u{2aa2}" },
        { "&NotNestedLessLess;", "\u{2aa1}" },
        { "&NotPrecedes;", "\u{2280}" },
        { "&NotPrecedesEqual;", "\u{2aaf}" },
        { "&NotPrecedesSlantEqual;", "\u{22e0}" },
        { "&NotReverseElement;", "\u{220c}" },
        { "&NotRightTriangle;", "\u{22eb}" },
        { "&NotRightTriangleBar;", "\u{29d0}" },
        { "&NotRightTriangleEqual;", "\u{22ed}" },
        { "&NotSquareSubset;", "\u{228f}" },
        { "&NotSquareSubsetEqual;", "\u{22e2}" },
        { "&NotSquareSuperset;", "\u{2290}" },
        { "&NotSquareSupersetEqual;", "\u{22e3}" },
        { "&NotSubset;", "\u{2282}" },
        { "&NotSubsetEqual;", "\u{2288}" },
        { "&NotSucceeds;", "\u{2281}" },
        { "&NotSucceedsEqual;", "\u{2ab0}" },
        { "&NotSucceedsSlantEqual;", "\u{22e1}" },
        { "&NotSucceedsTilde;", "\u{227f}" },
        { "&NotSuperset;", "\u{2283}" },
