...
namespace Hanami::HTML {
    ...
    void Parser::process_token(const Token& token)
    {
    ...
    auto Parser::adjusted_current_node() const noexcept -> Element*
    {
    ...
    auto Parser::current_node_is_any_of(std::span<const std::string_view> tags) const noexcept -> bool
    {
    ...
    auto Parser::appropriate_insertion_place(std::optional<Node*> override_target) const noexcept -> NodeListLocation
    {
    ...
    void Parser::insert_character(std::string_view data) noexcept
    {
    ...
    void Parser::insert_comment(std::string_view data, std::optional<NodeListLocation> pos) noexcept
    {
    ...
    void Parser::insert_element_at_adjusted_insertion_location(Element* element, NodeListLocation adjusted_insertion_location)
    {
        // Let the adjusted insertion location be the appropriate place for inserting a node.
    ...
    auto Parser::insert_html_element(const Token& token) -> Element*
    {
        return insert_foreign_element(token, html_namespace, false);
    }

    // https://html.spec.whatwg.org/multipage/parsing.html#insert-a-foreign-element
    auto Parser::insert_foreign_element(const Token& token, std::string_view element_namespace, bool only_add_to_element_stack) -> Element*
    {
    ...
    auto Parser::create_element_for_token(const Token& token, std::string_view element_namespace, Node* intended_parent) -> Element*
    {
    ...
    auto Parser::create_element_internal(
        Document* document,
    ...
    void Parser::parse_generic_raw_text_element(const Token& token)
    {
        parse_generic_rcdata_element(token, true);
    }

    // https://html.spec.whatwg.org/multipage/parsing.html#generic-rcdata-element-parsing-algorithm
    void Parser::parse_generic_rcdata_element(const Token& token, bool generic_raw_text_parse)
    {
        // Insert an HTML element for the token.
        insert_html_element(token);
